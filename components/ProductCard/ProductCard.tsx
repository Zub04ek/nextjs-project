...
export const ProductCard = ({
	...
	return (
		<a
			href="/products"
			className="block w-fit rounded-2xl bg-white overflow-hidden hover:shadow-[4px_4px_24px_0px_#04032329] transition-shadow duration-500"
		>
			<Image
				src={thumbnail}
				alt="product photo"
			...
			<div className="py-4 px-6">
				...
				<p className="font-open_sans font-bold text-[32px] leading-8 text-black">${price}</p>
			</div>
		</a>
	);
};
